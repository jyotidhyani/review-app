...
const ReviewItem = ({ userName, title, description, buyLink, imageUrl, shouldBuy }) => {
  return (
    <div className="review-item">
      ...
      <div className="recommendation">{shouldBuy ? <span><i class="fa fa-check-circle"></i> Yes, I recommend this product</span> : <span><i class="fa fa-times-circle"></i> No, I do not recommend this product</span>}</div>
